...
async function promptRuntime(rl: PromptInterface | null, scriptedAnswers: ScriptedAnswers): Promise<Runtime> {
...
async function selectRuntime(argv: string[], shouldPromptForMissing: boolean, rl: PromptInterface | null, scriptedAnswers: ScriptedAnswers): Promise<Runtime> {
