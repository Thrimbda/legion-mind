...
function getValue(argv: string[], name: '--agent' | '--runtime'): string | null {
...
function isInteractiveSetup(argv: string[], rawCommand: LgmindCommand): boolean {
...
async function selectRuntime(argv: string[], rawCommand: LgmindCommand): Promise<Runtime> {
