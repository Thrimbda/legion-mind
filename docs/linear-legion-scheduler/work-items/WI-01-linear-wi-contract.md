...
- [ ] 有 Linear native agent 对象职责表，说明 delegate、AgentSession、Activities、Plan、externalUrls、stop signal 与 Scheduler DB truth 的边界。
- [ ] 有 terminal success / terminal non-success / blocker satisfied 术语表，明确非成功终态默认不解锁 downstream。
