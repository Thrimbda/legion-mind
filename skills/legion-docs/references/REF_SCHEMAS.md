...
- `.legion/tasks/<task-id>/plan.md`、`log.md`、`tasks.md` 与 `docs/*.md` 默认使用当前用户与 agent 的工作语言。
...
### 结构（推荐）
参考模板：`skills/spec-rfc/references/TEMPLATE_RESEARCH.md`
...
模板参考：
- `skills/spec-rfc/references/TEMPLATE_IMPLEMENTATION_PLAN.md`
...
- `<taskRoot>/docs/` 下的文件应在 `log.md` 的“关键文件”里登记（便于交接）。
