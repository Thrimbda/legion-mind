...
| **`context read [--task-id <id>] [--section ...] [--include-reviews true|false]`** | 读取 context 内容 | `taskId`, `section`, `includeReviews` |
| **`task list`** | 列出所有任务及状态 | - |
...
| `legion_update_context` | `context update` |
