...
- Git worktree + PR lifecycle envelope 的当前硬规则是每个 task `0..1` PR、identity write-once、terminal 后 external-only；见 `decisions.md`、`patterns.md`、`tasks/enforce-single-pr-lifecycle-v1.md`、`tasks/add-git-worktree-pr-envelope.md` 与 `tasks/fix-aim-autonomous-pr-flow.md`，执行细节真源是 `skills/git-worktree-pr/SKILL.md`。
